...
App::$strings["Your account on %s will expire in a few days."] = "Dein Konto auf %s wird in ein paar Tagen verfallen.";
App::$strings["Your Friendica test account is about to expire."] = "Dein Friendica-Testkonto wird bald verfallen.";
