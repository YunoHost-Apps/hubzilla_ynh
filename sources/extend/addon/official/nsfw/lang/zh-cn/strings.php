...
App::$strings["Not Safe For Work (General Purpose Content Filter) settings"] = "工作不安全（通用内容过滤）设置";
...
App::$strings["Enable Content filter"] = "使内容过滤可用";
App::$strings["Comma separated list of keywords to hide"] = "逗号分隔单词要隐藏";
App::$strings["Submit"] = "提交";
App::$strings["Use /expression/ to provide regular expressions"] = "用/<i>表达式</i>/为输入正则表达式";
App::$strings["NSFW Settings saved."] = "NSFW设置保持了。";
App::$strings["%s - Click to open/close"] = "%s - 点击为打开／关闭";
