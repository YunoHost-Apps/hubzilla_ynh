...
App::$strings["Not Safe For Work (General Purpose Content Filter) settings"] = "Not Safe For Work (General Purpose Content Filter) nastavení";
...
App::$strings["Enable Content filter"] = "Povolit Kontextový filtr";
App::$strings["Comma separated list of keywords to hide"] = "Čárkou oddělený seznam klíčových slov ke skrytí";
App::$strings["Submit"] = "Odeslat";
App::$strings["Use /expression/ to provide regular expressions"] = "Použít /výraz/ pro použití regulárních výrazů";
App::$strings["NSFW Settings saved."] = "NSFW nastavení uloženo";
App::$strings["%s - Click to open/close"] = "%s - Klikněte pro otevření/zavření";
