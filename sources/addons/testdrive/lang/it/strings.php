...
App::$strings["Your account on %s will expire in a few days."] = "Il tuo account su %s scadrà tra pochi giorni.";
App::$strings["Your Friendica test account is about to expire."] = "Il tuo account di prova su Friendica sta per scadere.";
